...
int main() {
	...
	#pragma omp parallel reduction(+:global_ctr)
	{
		...
		for(uint64_t iIV = 0; iIV < NIV; iIV++) {
			...
			int output = 0;
			output = (OD[0]>>16)&0x1 ^ (OD[0]>>0)&0x1 ^ (OD[5]>>7)&0x1 ^ (OD[10]>>0)&0x1 ^ (OD[15]>>24)&0x1 ^
			         ...
			         ((OD[1]>>6)&0x1) & (((OD[6]>>13)&0x1) ^ ((OD[11]>>6)&0x1) ^ 0x1) ^
			         ((OD[1]>>5)&0x1) & (((OD[6]>>12)&0x1) ^ ((OD[11]>>5)&0x1) ^ 0x1) & (((OD[1]>>6)&0x1) ^ ((OD[6]>>13)&0x1) ^ ((OD[11]>>6)&0x1) ^ 0x1) ^
			         ((OD[11]>>11)&0x1) & (((OD[12]>>11)&0x1) ^ 0x1) ^
			         ((OD[11]>>10)&0x1) & (((OD[12]>>10)&0x1) ^ 0x1) & (((OD[11]>>11)&0x1) ^ ((OD[12]>>11)&0x1) ^ 0x1) ^
			         (OD[2]>>24)&0x1 ^ (OD[2]>>19)&0x1 ^ (OD[2]>>16)&0x1 ^ (OD[2]>>8)&0x1 ^ (OD[2]>>7)&0x1 ^ (OD[2]>>0)&0x1 ^
			         (OD[7]>>26)&0x1 ^ (OD[7]>>15)&0x1 ^ (OD[7]>>7)&0x1 ^ (OD[7]>>6)&0x1 ^
			         (OD[8]>>31)&0x1 ^ (OD[8]>>19)&0x1 ^ (OD[8]>>18)&0x1 ^ (OD[8]>>8)&0x1 ^ (OD[8]>>0)&0x1 ^
			         (OD[13]>>27)&0x1 ^ (OD[13]>>24)&0x1 ^ (OD[13]>>18)&0x1 ^ (OD[13]>>15)&0x1 ^ (OD[13]>>0)&0x1 ^
			         ((OD[2]>>7)&0x1) & (((OD[7]>>14)&0x1) ^ ((OD[8]>>7)&0x1) ^ 0x1) ^
			         ((OD[2]>>6)&0x1) & (((OD[7]>>13)&0x1) ^ ((OD[8]>>6)&0x1) ^ 0x1) & (((OD[2]>>7)&0x1) ^ ((OD[7]>>14)&0x1) ^ ((OD[8]>>7)&0x1) ^ 0x1) ^
			         ((OD[8]>>17)&0x1) & (((OD[13]>>17)&0x1) ^ 0x1) ^
			         ((OD[8]>>16)&0x1) & (((OD[13]>>16)&0x1) ^ 0x1) & (((OD[8]>>17)&0x1) ^ ((OD[13]>>17)&0x1) ^ 0x1) ^
			         (OD[4]>>7)&0x1 ^ (OD[9]>>0)&0x1 ^
			         (OD[4]>>19)&0x1 ^ (OD[4]>>13)&0x1 ^ (OD[9]>>12)&0x1 ^ (OD[9]>>6)&0x1 ^
			         (OD[9]>>26)&0x1 ^ (OD[14]>>26)&0x1 ^
			         (OD[14]>>8)&0x1 ^
			         ((OD[9]>>25)&0x1) & (((OD[14]>>25)&0x1) ^ 0x1) ^
			         ((OD[9]>>24)&0x1) & (((OD[14]>>24)&0x1) ^ 0x1) & (((OD[9]>>25)&0x1) ^ ((OD[14]>>25)&0x1) ^ 0x1);
